      ...
      let o = new WeakMap(),
        ...
        F = (e) => {
          ...
          if (c(e) !== e || i || a)
            ...
            if ((t = x.get(e))) return t;
            if (((t = ++A + "~"), x.set(e, t), Array.isArray(e))) {
      ...
      async function N() {
        ...
        async function m(e) {
          ...
          let [u, g] = E(n, i),
            ...
            _ = () => {
              ...
              return (f(l.revalidate)
                ...
                : !1 !== l.revalidate) && (delete b[i], delete S[i], t && t[0])
                ? t[0](2).then(() => u().data)
                : u().data;
            };
          ...
          let k = !d(v),
            ...
            V = L._c,
            C = d(V) ? T : V;
          if ((k && g({ data: (v = f(v) ? v(C, T) : v), _c: C }), f(O)))
            try {
              O = O(C);
            } catch (e) {
              r = e;
      ...
      let en =
        ((n = (e, t, r) => {
          let {
            ...
            Y = S[k] && S[k].length > 0,
            ee = Q.data,
            en = d(ee) ? (G && h(G) ? et(G) : G) : ee,
            ei = Q.error,
            ea = (0, i.useRef)(en),
            eu = b ? (d(ee) ? (d(ea.current) ? en : ea.current) : ee) : en,
            eo =
              (!Y || !!d(ei)) &&
              (X && !d(p)
                ? p
                : !M().isPaused() && (l ? !d(en) && v : d(en) || v)),
            el = !!(k && t && X && eo),
            ...
            ed = (0, i.useCallback)(
              async (e) => {
                let t, n;
                let i = A.current;
                if (!k || !i || x.current || M().isPaused()) return !1;
                let a = !0,
                  o = e || {},
                  l = !O[k] || !o.dedupe,
                  c = () =>
                    L
                      ? !x.current && k === j.current && P.current
                      : k === j.current,
            ...
            ef = (0, i.useCallback)((...e) => N(n, j.current, ...e), []);
          if (
            (C(() => {
            ...
            C(() => {
              ...
              function r() {
                !q().error && (y || M().isVisible()) && (m || M().isOnline())
                  ? ed(er).then(t)
                  : t();
              }
              return (
            ...
            (A.current = t), (F.current = r), (x.current = !1);
            let e = R[k];
            if ((d(e) || et(ef(e)), d(ei))) {
              let e = ed(er);
