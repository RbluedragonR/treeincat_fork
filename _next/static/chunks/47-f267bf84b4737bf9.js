    ...
    8173: (e, t, n) => {
      ...
      let y = o.default.forwardRef(function (e, t) {
        ...
        let O = o.default.useContext(u.AppRouterContext),
          P = !1 !== _,
          F = null === _ ? a.PrefetchKind.AUTO : a.PrefetchKind.FULL,
          { href: x, as: k } = o.default.useMemo(() => {
            let e = p(s);
            return { href: e, as: y ? p(y) : e };
          }, [s, y]),
          T = o.default.useRef(x),
          A = o.default.useRef(k);
        R && (r = o.default.Children.only(n));
        let I = R ? r && "object" == typeof r && r.ref : t,
          [z, M, N] = (0, l.useIntersection)({ rootMargin: "200px" }),
          U = o.default.useCallback(
            (e) => {
              (A.current !== k || T.current !== x) &&
                (N(), (A.current = k), (T.current = x)),
                z(e);
            },
            [k, x, N, z]
          ),
          L = (0, c.useMergedRef)(U, I);
        o.default.useEffect(() => {
          O && M && P && h(O, x, { kind: F });
        }, [k, x, M, P, O, F]);
        let q = {
